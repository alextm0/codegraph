...
\begin{frame}{Quantitative Results}
    ...
    \begin{tabular}{lcc}
        \toprule
        \textbf{Method} & \textbf{Recall@10} & \textbf{Zero-Recall} \\
        \midrule
        BM25 (Text Baseline) & 58.0\% & 126 \\
        CodeGraph (Uniform PPR) & \textbf{\textcolor{MutedTeal}{74.0\%}} & \textbf{\textcolor{MutedTeal}{78}} \\
        \bottomrule
    \end{tabular}
    \end{center}
\end{frame}
