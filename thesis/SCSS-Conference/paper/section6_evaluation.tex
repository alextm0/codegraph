...
The initial configuration of CodeGraph achieved 42.0\% Recall@10. Through systematic engineering of the seed stage, the final optimal configuration reached \textbf{74.0\% Recall@10}, a 24.3 percentage point improvement over the competitive BM25-only baseline (49.7\%). This trajectory records the full performance gain from initial unoptimized graph propagation to the final structural retriever.
