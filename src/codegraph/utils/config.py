...
def parse_signal_weights(seed_section: dict) -> dict[str, float]:
    ...
    Returns a dict with keys: entity_match, bm25, issue_hint, bm25_top_n.
    ...
    if seed_section.get("issue_hint_weight") is not None:
        signal_weights["issue_hint"] = float(seed_section["issue_hint_weight"])
